...
void main() {
  group('DropletSize Mapping', () {
    ...
    test('should map storage optimized Intel droplets correctly', () {
      final size = DropletSize(
        slug: 'so-2vcpu-16gb-intel',
        memory: 16384,
        vcpus: 2,
        disk: 50,
        transfer: 1000,
        ...
        regions: ['nyc1'],
        available: true,
        description: 'Storage Optimized Intel Droplet',
      );
    ...
    test('should map general purpose 2x SSD Intel droplets correctly', () {
      final size = DropletSize(
        slug: 'gd-2vcpu-8gb-intel',
        memory: 8192,
        vcpus: 2,
        disk: 50,
        transfer: 1000,
        ...
        regions: ['nyc1'],
        available: true,
        description: 'General Purpose 2x SSD Intel Droplet',
      );
    ...
    test('should map CPU optimized 2x SSD Intel droplets correctly', () {
      final size = DropletSize(
        slug: 'c2-2vcpu-4gb-intel',
        memory: 4096,
        vcpus: 2,
        disk: 50,
        transfer: 1000,
        ...
        regions: ['nyc1'],
        available: true,
        description: 'CPU Optimized 2x SSD Intel Droplet',
      );
    ...
    test('should map memory optimized 3x SSD Intel droplets correctly', () {
      final size = DropletSize(
        slug: 'm3-2vcpu-16gb-intel',
        memory: 16384,
        vcpus: 2,
        disk: 150,
        transfer: 1000,
        ...
        regions: ['nyc1'],
        available: true,
        description: 'Memory Optimized 3x SSD Intel Droplet',
      );
    ...
    test('should map memory optimized 6x SSD Intel droplets correctly', () {
      final size = DropletSize(
        slug: 'm6-2vcpu-16gb-intel',
        memory: 16384,
        vcpus: 2,
        disk: 300,
        transfer: 1000,
        ...
        regions: ['nyc1'],
        available: true,
        description: 'Memory Optimized 6x SSD Intel Droplet',
      );
